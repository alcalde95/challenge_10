...
const FormTable = () => {
    const {
        nombre_caja, setnombre_caja,
        species_caja, setspecies_caja,
        description_caja, setdescription_caja,
        soil_caja, setsoil_caja,
        temperature_caja, settemperature_caja,
        sun_caja, setsun_caja,
        water_caja, setwater_caja,
        multiplication_caja, setmultiplication_caja
    } = useContext(TableUseStatescontext)
