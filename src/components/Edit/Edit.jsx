...
const Edit = () => {
    ...
    const [nombre_caja, setnombre_caja] = useState(state.name)
    const [species_caja, setspecies_caja] = useState(state.species)
    const [description_caja, setdescription_caja] = useState(state.description)
    const [soil_caja, setsoil_caja] = useState(state.soil)
    const [temperature_caja, settemperature_caja] = useState(state.temperature)
    const [sun_caja, setsun_caja] = useState(state.sun)
    const [water_caja, setwater_caja] = useState(state.water)
    const [multiplication_caja, setmultiplication_caja] = useState(state.multiplication)
